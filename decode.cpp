            ...
            else if (inst[0] == "REVSH") //linha 31
            {
                if (inst[1][0] == 'R')
                {
                    if (inst[2][0] == 'R')
                    {
                        ...
                        valor |= 0b1011101011 << 6;
                        printf("%x\n", valor);
                    }
                }
            }
            else if (inst[0] == "SETEND" && inst[1] == "LE") //linha 33
            {
                valor = 0;
                valor |= 0b1011011001010000;
                printf("%x\n", valor);
            }
            else if (inst[0] == "SETEND" && inst[1] == "BE") //linha 33
            {
                valor = 0;
                valor |= 0b1011011001011000;
                printf("%x\n", valor);
            }
